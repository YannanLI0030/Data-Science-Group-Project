...
const goldPath = path.join(repo, "benchmarks/gold_standard_v5_holdout.csv");
const completedReviewPath = path.join(repo, "benchmarks/candidate_pool_v5_holdout_review_completed.csv");
const labelFreezeManifestPath = path.join(repo, "benchmarks/gold_standard_v5_holdout_manifest.json");
...
const outputDir = path.join(repo, "results/v5_holdout_evaluation");
